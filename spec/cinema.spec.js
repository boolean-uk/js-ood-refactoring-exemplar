...
describe('Cinema', () => {
  ...
  it('returns error trying to schedule showing when film does not exist', () => {
    ...
    const result = cinema.addStartTime('Film doesnt exist!', 'Screen #1', '10:00');
  ...
  it('returns error trying to schedule showing when screen does not exist', () => {
    ...
    const result = cinema.addStartTime('Film1', 'Screen Doesnt exist', '10:00');
    expect(result).toBe(expected);
  });
  ...
  it('schedules single film', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
  ...
  it('schedules same film on same screen', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    cinema.addStartTime('Film1', 'Screen #1', '12:10');
  ...
  it('schedules same film on multiple screens', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    cinema.addStartTime('Film1', 'Screen #2', '10:00');
  ...
  it('schedules multiple films on multiple screens', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    cinema.addStartTime('Film1', 'Screen #2', '12:00');

    cinema.addStartTime('Film2', 'Screen #1', '12:00');
    cinema.addStartTime('Film2', 'Screen #2', '09:00');
  ...
  it('returns error when film screening overlaps start', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    const result = cinema.addStartTime('Film1', 'Screen #1', '11:00');
  ...
  it('returns error when film screening overlaps end', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    const result = cinema.addStartTime('Film1', 'Screen #1', '09:10');
    const expected = 'Time unavailable';
    expect(result).toEqual(expected);
  });
  ...
  it('returns error when film screening overlaps all', () => {
    ...
    cinema.addStartTime('Film1', 'Screen #1', '10:00');
    const result = cinema.addStartTime('Film2', 'Screen #1', '08:30');
    const expected = 'Time unavailable';
    expect(result).toEqual(expected);
  });
});
